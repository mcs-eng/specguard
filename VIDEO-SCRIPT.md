...
- Narration [30]: "Twenty real runs on the fixtures, against a named code revision. And in print: what these numbers do not exercise, and whether any of them moved since the last published run."
